...
class bea_acf_field_taxonomy_term extends acf_field {
	...
	function input_admin_enqueue_scripts() {
		...
		wp_register_script( 'acf-input-taxonomy-term', $url . 'assets/js/input' . $suffix . '.js', array( 'jquery', 'underscore', 'select2' ) );
	...
	function render_field( $field ) {
		...
		<select id="bea_acf_tt_tax" class="bea_acf_taxonomy_term_taxonomies widefat" <?php __checked_selected_helper( true, $field['bea_acf_tt_allow_multiple'], true, 'multiple' ); ?> name="<?php echo esc_attr( $field['name'] ); ?>[taxonomies][]">
		...
		<select id="bea_acf_tt_allow_multiple" class="bea_acf_taxonomy_term_taxonomies_terms widefat" <?php __checked_selected_helper( true, $field['bea_acf_tt_allow_multiple'], true, 'multiple' ); ?>name="<?php echo esc_attr( $field['name'] ); ?>[terms][]">
			<option value=""><?php esc_html_e( 'None', 'bea-acf-tt' ) ?></option>
